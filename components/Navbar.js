    ...
    <ul className="flex gap-3">
      ...
      {/* <li className="relative">
        <span
          ...
          className={`inline-flex items-center  px-1 pt-1 text-sm font-medium text-color3 cursor-pointer`}
        >
          عملیات مالی
        </span>
        <ul
          style={{ display: submenuVisible ? "flex" : "none" }}
          onMouseEnter={showSubmenu}
          onMouseLeave={hideSubmenu}
          className="flex-col gap-2  absolute w-[150px] rounded-lg  bg-gray-300 p-3"
        >
          <li className="w-full bg-color2 p-2 rounded-md text-color3 text-center cursor-pointer">
            <Link
              href="/buy"
              className={` inline-flex items-center cursor-pointer ${
                isActive("/sell") ? "text-green-600" : ""
              } px-1 pt-1 text-sm font-medium ${
                isActive("/buy") ? "text-color3" : ""
              }`}
            >
              خرید
            </Link>
          ...
          <li className="w-full bg-color2 p-2 rounded-md text-color3 text-center cursor-pointer">
            <Link
              ...
              className={`inline-flex items-center cursor-pointer  ${
                ...
                isActive("/sell") ? "text-green-400" : "text-color3"
              }`}
            >
              فروش
            </Link>
