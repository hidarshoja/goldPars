    ...
    >
      <div className="w-[100%] md:w-[450px] min-h-[530px] bg-[#272523] rounded-xl p-3 mt-24">
        ...
        <div className="border-2 border-color2 rounded-xl p-3 mt-6">
          <p className="text-color3 text-sm"> وزن را وارد کنید :</p>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-5">
              ...
              >
                {new Intl.NumberFormat("fa-IR").format(10)} +
              </button>
              <button
                className="w-1/2 border-2 py-2 rounded-lg border-color2 text-color2 hover:bg-color2 hover:text-color3"
          ...
          <p className="text-color3 mt-3 text-sm"> قیمت طلا را وارد کنید :</p>
          {/* وزن */}
          <div className="relative mt-2 rounded-md shadow-sm">
            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
